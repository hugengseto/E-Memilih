...
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="login-logo">
            <a href="/assets/index2.html">E-<b>Memilih</b></a>
        </div>
        <!-- /.login-logo -->
        <div class="login-box-body">
            ...
            <form action="<?= base_url('/auth'); ?>" method="post">
                <div class="form-group has-feedback <?= session('errors') && isset(session('errors')['username']) ? 'has-error' : ''; ?>">
                ...
                <div class="form-group has-feedback <?= session('errors') && isset(session('errors')['password']) ? 'has-error' : ''; ?>">
