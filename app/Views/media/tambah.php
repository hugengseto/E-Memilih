...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Media Pemilihan
            <small>Tambahkan media baru</small>
        </h1>
        <ol class="breadcrumb">
        ...
        <div class="row tambah">
            ...
            <div class="col-md-8">
                ...
                <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form action="/admin/media_pemilihan/aksi_tambah" method="post" enctype="multipart/form-data">
                        <?= csrf_field(); ?>
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group <?= session('errors') && isset(session('errors')['judul_pemilihan']) ? 'has-error' : ''; ?>">
                                ...
                                <input type="text" class="form-control" id="judul_pemilihan" name="judul_pemilihan" value="<?= old('judul_pemilihan'); ?>" placeholder="Masukkan judul pemilihan">
                            ...
                            <div class="form-group <?= session('errors') && isset(session('errors')['pelaksanaan']) ? 'has-error' : ''; ?>">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control pull-right" id="pelaksanaan" name="pelaksanaan" value="<?= old('pelaksanaan'); ?>">
                                </div>
                                <!-- /.input group -->
                            ...
                            <div class="form-group <?= session('errors') && isset(session('errors')['poster']) ? 'has-error' : ''; ?>">
                                ...
                                <img id="poster-preview" src="/img/vote.png" alt="Pratinjau Poster">
                            </div>
                            <!-- input kata kunci -->
                            <div class="form-group <?= session('errors') && isset(session('errors')['kata_kunci']) ? 'has-error' : ''; ?>">
                                <label for="kata_kunci">*Kata Kunci</label>
                                <input type="text" class="form-control" id="kata_kunci" name="kata_kunci" value="<?= old('kata_kunci'); ?>" placeholder="Masukkan judul pemilihan">
