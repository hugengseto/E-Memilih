...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Peserta Baru
            <small>Tambahkan data peserta</small>
        </h1>
        <ol class="breadcrumb">
        ...
        <div class="row tambah">
            ...
            <div class="col-md-8">
                ...
                <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form action="/admin/media_pemilihan/aksi_tambah/peserta/<?= $media['slug']; ?>" method="post" enctype="multipart/form-data">
                        <?= csrf_field(); ?>
                        ...
                        <div class="box-body <?= session('errors') && isset(session('errors')['tanggal_lahir']) ? 'has-error' : ''; ?>">
                            ...
                            <div class="form-group <?= session('errors') && isset(session('errors')['nama_lengkap']) ? 'has-error' : ''; ?>">
                                ...
                                <input type="text" class="form-control" id="nama_lengkap" name="nama_lengkap" value="<?= old('nama_lengkap'); ?>" placeholder="Masukkan Nama Lengkap">

                                <?php if (session('errors') && isset(session('errors')['nama_lengkap'])) : ?>
                            ...
                            <div class="form-group <?= session('errors') && isset(session('errors')['tanggal_lahir']) ? 'has-error' : ''; ?>">
                                ...
                                <div class="input-group date">
                                    ...
                                    <input type="text" class="form-control pull-right" id="datepicker" name="tanggal_lahir" value="<?= old('tanggal_lahir'); ?>">
                                </div>
                            ...
                            <div class="form-group <?= session('errors') && isset(session('errors')['nomor_whatsapp']) ? 'has-error' : ''; ?>">
                                ...
                                <input type="number" class="form-control" id="nomor_whatsapp" name="nomor_whatsapp" value="<?= old('nomor_whatsapp'); ?>" placeholder="Masukkan Nomor Whatsapp">
